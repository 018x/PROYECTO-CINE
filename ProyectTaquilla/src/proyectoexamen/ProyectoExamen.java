...
public class ProyectoExamen extends JFrame implements ActionListener, ItemListener{
        ...
        ImageIcon lucy,box,can,tor,torna,ninfo,login,spider,wish,wonka,blade,john,viernes,trans,saw,fla;
...
// Agregar un JPanel como fondo
JPanel fondoRojo = new JPanel();
fondoRojo.setBackground(Color.RED);
fondoRojo.setBounds(0, 0, 400, 50); 


ventana.add(fondoRojo);

ventana.setComponentZOrder(fondoRojo, 0);
...
pelicula.addItem("Spider-verso");
pelicula.addItem("Wish");
pelicula.addItem("Wonka");
pelicula.addItem("Blade runner");
pelicula.addItem("John wick 4");
pelicula.addItem("Viernes negro");
pelicula.addItem("Transformers");
pelicula.addItem("Saw X");
...
pelicula.setBounds(65, 100, 140, 20);
        	...
        	horario.addItem("3:00 pm.");
		horario.addItem("4:00 pm.");
		horario.addItem("6:10 pm.");
                horario.addItem("11:15 pm.");
                horario.addItem("9:00 pm.");
		horario.addItem("6:00 pm.");
		horario.addItem("5:00 pm.");
                horario.addItem("9:15 pm.");
                horario.addItem("12:00 pm.");
                ventana.add(horario);
        ...
        spider=new ImageIcon("Spider-verso.jpg");
        wish=new ImageIcon("Wish.jpg");
        wonka=new ImageIcon("Wonka.jpg");
        blade=new ImageIcon("Blade runner.jpg");
        john=new ImageIcon("Jhon wick 4.jpg");
        viernes=new ImageIcon("Viernes negro.jpg");
        trans=new ImageIcon("Transformers.jpg");
        saw=new ImageIcon("Saw X.jpg");
        fla=new ImageIcon("Flash.jpg");
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(salas.equals("Spider-verso")){  
                    Graphics papel = cartel.getGraphics();
                    spider.paintIcon(this, papel, 0, 0);sala1.setText("7");  }
        if(salas.equals("Wish")){  
                    Graphics papel = cartel.getGraphics();
                    wish.paintIcon(this, papel, 0, 0);sala1.setText("8");  }
        if(salas.equals("Wonka")){  
                    Graphics papel = cartel.getGraphics();
                    wonka.paintIcon(this, papel, 0, 0);sala1.setText("9");  }
        if(salas.equals("Blade runner")){  
                    Graphics papel = cartel.getGraphics();
                    blade.paintIcon(this, papel, 0, 0);sala1.setText("10");  }
        if(salas.equals("John wick 4")){  
                    Graphics papel = cartel.getGraphics();
                    john.paintIcon(this, papel, 0, 0);sala1.setText("11");  } 
        if(salas.equals("Viernes negro")){  
                    Graphics papel = cartel.getGraphics();
                    viernes.paintIcon(this, papel, 0, 0);sala1.setText("12");  }
        if(salas.equals("Transformers")){  
                    Graphics papel = cartel.getGraphics();
                    trans.paintIcon(this, papel, 0, 0);sala1.setText("13");  } 
        if(salas.equals("Saw X")){  
                    Graphics papel = cartel.getGraphics();
                    saw.paintIcon(this, papel, 0, 0);sala1.setText("14");  } 
        if(salas.equals("Flash")){  
                    Graphics papel = cartel.getGraphics();
                    fla.paintIcon(this, papel, 0, 0);sala1.setText("7");  }}
        ...
        if(e.getSource()==login2){
           ...
           if((U.equals("David"))&&(C.equals("1234"))){
           ...
           if((U.equals("jorge"))&&(C.equals("1234"))){
            ProyectoExamen marco = new ProyectoExamen();
            marco.setSize(1200,800);
            marco.crearGUI();
            marco.setVisible(true);
